...
(defrule REGLA-CLIPS-OT-N4-11111
...
(defrule REGLA-CLIPS-OT-N4-1 (Entrevista (OrientacionTemporal_DiaSemana "NO")) (OrientacionTemporal (cFecha -0.50)) (OrientacionTemporal (cMes -1.00)) (OrientacionTemporal (cAno -2.50)) (OrientacionTemporal (cEstacion "NO")) => (assert (Orientacion (cOrientacionTemporal -4.00))) (assert (DiagnosticoDetalle (ResultadoDetalle "#####"))) (printout t REGLA-CLIPS-OT-N4-1 crlf ))
